...
AUTHENTICATION_BACKENDS = [
    ...
    'django.contrib.auth.backends.ModelBackend', # Esta es la autenticación por defecto de Django
]


AXES_LOGIN_FAILURE_LIMIT = 5
AXES_LOCK_OUT_AT_FAILURE = True
AXES_COOLOFF_TIME = timedelta(minutes=1)  # Tiempo de bloqueo tras fallos
